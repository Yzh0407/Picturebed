...
$config=Array
	...
	'tips'=>'<a><i class="icon icon-heart">图床所有者邮箱haruka0233@outlook.com</i></a>
...
<a><li class="icon icon-bullhorn text-muted"> 单文件≤20M,每天限制上传≤20张（未登录用户）</li></a>',
	'notice_status'=>1,
	'notice'=>'<a><i class="icon icon-heart">如需联系图床所有者，邮箱haruka0233@outlook.com</i></a>
<br>
...
<br>
<a><li class="icon icon-bullhorn text-muted"> 单文件≤20M,每天限制上传≤20张（未登录用户）</li></a>',
	'domain'=>'http://101.34.84.130:99',
	'imgurl'=>'http://101.34.84.130:99',
	'user'=>'haruka',
