...
$config=Array
	(
	'title'=>'梦葉樱 - 图床',
	'keywords'=>'梦葉樱的图床,无数据库图床,免费图床,PHP多图长传程序,自适应页面,一键复制链接,HTML5,markdown,bbscode',
	'description'=>'梦葉樱的图床是一款支持多文件上传的无数据库图床,可以完美替代PHP多图上传程序,最新html5自适应页面兼容手机电脑,上传后返回图片直链,markdown图片等',
	'tips'=>'<a><i class="icon icon-heart">图床所有者邮箱haruka233@foxmail.com</i></a>
<a href="https://github.com/icret/EasyImages2.0"><i class="icon icon-github">基于开源的EasyImage2.0 简单图床, 无需数据库</i></a>
<a><li class="icon icon-bullhorn text-muted"> 单文件≤20M,单次上传≤200张（登录用户）</li></a>
<a><li class="icon icon-bullhorn text-muted"> 单文件≤20M,每天限制上传≤20张（未登录用户）</li></a>',
	'notice_status'=>1,
	'notice'=>'<a><i class="icon icon-heart">如需联系图床所有者，邮箱haruka233@foxmail.com</i></a>
<br>
<a href="https://github.com/icret/EasyImages2.0"><i class="icon icon-github">基于开源的EasyImage2.0 简单图床, 支持多文件上传无数据库</i></a>
<br>
<a><li class="icon icon-bullhorn text-muted"> 单文件≤20M,单次上传≤200张（登录用户）</li></a>
<br>
<a><li class="icon icon-bullhorn text-muted"> 单文件≤20M,每天限制上传≤20张（未登录用户）</li></a>',
	'domain'=>'https://img.haruka.net.cn',
	'imgurl'=>'https://img.haruka.net.cn',
	'user'=>'haruka',
	'password'=>'a7f036514301566640ed3d984416067f84bb5eb8a9c2d7011afd485b8579f0e8',
	'ftp_status'=>0,
	'ftp_host'=>'',
	'ftp_port'=>21,
	'ftp_user'=>'',
	...
	'extensions'=>'jpg,jpeg,png,gif,bmp,webp,ico,jfif,tif,tga,mp3,mp4',
	'compress'=>0,
	'compress_ratio'=>80,
	'thumbnail'=>1,
	'thumbnail_w'=>258,
...
<div class="col-md-12" style="text-align: center;margin:2px;"><a href="https://app.cloudcone.com.cn/?ref=3521" target="_blank"><img src="/public/images/EasyImage2.0.png" /></a></div>',
	'ad_bot'=>0,
	'ad_bot_info'=>'<div class="col-md-12" style="text-align: center;margin-bottom:10px;"><span data-toggle="tooltip" title="联系图床管理员!"><button type="button" class="btn btn-mini btn-danger" data-toggle="modal" data-moveable="true" data-size="sm" data-icon="heart" data-title="您的赞美是我开发的动力!" data-custom="<ul class=\'nav nav-tabs\'><li class=\'active\'><a data-tab href=\'#wechat\'><i class=\'icon icon-wechat\' style=\'color:#329d38;\'> 微信</i></a></li></ul><div class=\'tab-content\'><div class=\'tab-pane active\' id=\'wechat\'><img src=\'<img src="https://img.picui.cn/free/2024/09/04/66d80781d2c63.jpg" alt="IMG_6295(20240904-150904).jpg" title="IMG_6295(20240904-150904).jpg" />\'></div><div class=\'tab-pane\' id=\'alipay\'><img src=\'https://img.picui.cn/free/2024/09/04/66d80781d2c63.jpg\'></div></div>"><i class="icon icon-heart"></i> 联系图床管理员 </button></span></div>',
