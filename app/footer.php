...
<footer class="container text-muted small navbar-fixed-bottom" style="text-align: center;background-color:rgba(255,255,255,0.7);z-index: 0;">
  ...
  <p>
    <!-- 页脚信息 -->
    <a href="http://101.34.84.130:88" target="_blank" rel="nofollow" data-toggle="tooltip" title="梦葉樱主站">主站</a>
    <a href="https://beian.miit.gov.cn/" target="_blank" rel="nofollow" data-toggle="tooltip" title="中国网站ICP备案">闽ICP备0000000号</a>
    <!--<a href="https://beian.miit.gov.cn/" target="_blank" data-toggle="tooltip" title="闽ICP备案0000000号">EasyImage</a>-->
    <a href="/app/DMCA.php" target="_blank" data-toggle="tooltip" title="用户使用协议">DMCA</a>
    <!-- 二维码按钮 -->
